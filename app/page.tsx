...
export default function Home() {
  ...
  return (
    <div className="bg-white">
      <Flex px="6" direction="column" justify="center" align="start">
        ...
        <Flex width="100%" justify="end" className="h-72">
          <div className="relative w-1/2 lg:h-full flex lg:items-end justify-center p-4">
            <svg
