...
const ErrorPageLayout = ({ code, name, description, extra }: Props) => {
  return (
    <div className="mt-12 mb-12 flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
